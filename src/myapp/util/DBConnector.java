    ...
    static {
        try {
           // sessionFactory = new Configuration().configure("hibernate.cfg.xml").buildSessionFactory();
            ...
            sessionFactory =new Configuration().configure(hbcfg).buildSessionFactory(); //start database session using hibernate       establish mysql session using hibernate.cfg.xml
